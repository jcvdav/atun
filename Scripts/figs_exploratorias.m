...
% El Niño has an ONI value greater than or equal to 0.5 that persists for
% at least five months, with a maximum value during the event that is
% greater than or equal to 1.0. Similarly, a La Niña has an ONI value less
% than or equal to –0.5 that persists for at least five months, with a
% minimum value during the event that is less than or equal to –1.0.
